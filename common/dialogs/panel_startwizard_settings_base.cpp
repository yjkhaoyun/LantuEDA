...
PANEL_STARTWIZARD_SETTINGS_BASE::PANEL_STARTWIZARD_SETTINGS_BASE( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style, const wxString& name ) : wxPanel( parent, id, pos, size, style, name )
{
	...
	m_staticText2 = new wxStaticText( this, wxID_ANY, _("您希望如何配置您的蓝兔智营 EDA 专属工作区？"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_btnUseDefaults = new wxRadioButton( this, wxID_ANY, _("使用蓝兔智营官方推荐的默认设置（推荐）"), wxDefaultPosition, wxDefaultSize, 0 );
